...
class Contact_Widget extends WP_Widget{
    ...
    public function __construct(){
        parent::__construct(
            ...
            __('Code-Architect Contact Widget','text_domain'), //Name
            array('description' => __('Code-Architect ajax powered contact widget','text_domain'))
        );
    }
    ...
    public function form($instance){
        if(isset($instance['title'])){
            ...
            $title = __('Code-Architect Contact Widget', 'text_domain');
        }
        $recipient  = $instance['recipient'];
        $subject    = $instance['subject'];
    ?>
   ...
   public function getForm($recipient, $subject){
        $output = '<div id="form-messages"></div>
